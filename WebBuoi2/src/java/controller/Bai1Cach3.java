 ...
 * @author DELL
 */
@WebServlet(name = "Bai1Cach3", urlPatterns = {"/bai1cach3"})
public class Bai1Cach3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Bai1Cach3</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Bài 1 cách 3:</h1>\n" +
"        <form action=\"bai1cach3\" method=\"post\">\n" +
"            Nhập bán kính:\n" +
